...
class ClockView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if let context = UIGraphicsGetCurrentContext() {
            ...
            // clock's border
            context.addEllipse(in: CGRect(x: rect.origin.x + borderWidth / 2, y: rect.origin.y + borderWidth / 2.0, width: rect.size.width - borderWidth, height: rect.size.height - borderWidth))
            ...
            let largetDotRadius: CGFloat = 6.0
            let centerCircle = CGRect(x: clockCenter.x - largetDotRadius, y: clockCenter.y - largetDotRadius, width: 2 * largetDotRadius, height: 2 * largetDotRadius)
            ...
            let centerCircles = CGRect(x: clockCenter.x - secondHandDotRadius, y: clockCenter.y - secondHandDotRadius, width: 2 * secondHandDotRadius, height: 2 * secondHandDotRadius)
            context.addEllipse(in: centerCircles)
